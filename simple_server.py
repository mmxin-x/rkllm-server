...
def handle_exception(e):
    ...
    traceback.print_exc()
    return format_openai_error_response(str(e), status_code=500)
...
def models_route():
    try:
        ...
        return format_openai_error_response(f"Error listing models: {str(e)}", status_code=500)
...
def chat_completions_route():
    try:
        ...
        return format_openai_error_response(f"Error in chat completions: {str(e)}", status_code=500)
